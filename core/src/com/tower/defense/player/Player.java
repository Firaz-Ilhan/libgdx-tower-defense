...
public class Player {
    ...
    /**
     * @param reward
     * @param enemiesMissed At the end of a wave, a Player gets a reward for surviving.
    ...
    /**
     * @param tower If a Tower was bought it is added to the list of the players towers(inventory)
    ...
    /**
     * @param index selling Towers only regain 80% of the costs. The result is rounded to an Integer
    ...
    /**
     * @param damage This method is called when an Enemy passed the Map without dying, The damage it deals is subtracted from the Players Life
     */
